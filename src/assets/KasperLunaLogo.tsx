...
export function BannerHero(): JSX.Element {
  return (
    <svg className="fill-black dark:fill-white" viewBox="0 0 1144 210.02">
      <path
        className="lettersLight dark:letters"
      ...
      />
      <polygon
        className="boxStuffLight dark:boxStuff"
        style={{ ["--order" as any]: "1" }}
...
export function StackHero() {
  return (
    <svg className="fill-black dark:fill-white" viewBox="0 0 698 381">
      <path
        className="lettersLight dark:letters"
        style={{ ["--order" as any]: "1" }}
