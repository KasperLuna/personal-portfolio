...
function SkillGroup({ title, array }: SkilGroupProps) {
  return (
    <div>
      <div className="hover:animate-scale focus-within:animate-scale mt-5 w-fit rounded-3xl border border-slate-300  px-5 shadow-md dark:border-white border-opacity-20 dark:border-opacity-20 sm:w-auto md:min-w-[730px]">
