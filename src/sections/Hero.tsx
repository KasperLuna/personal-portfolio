...
export default function Hero() {
  return (
    <div className="bg-white dark:bg-slate-900">
      <div className="-z-9 pointer-events-none absolute inset-x-0 top-[-10rem] transform-gpu overflow-hidden blur-3xl sm:top-[-20rem]">
        <svg
      ...
      <main>
        ...
        <div className="relative px-6 lg:px-8">
          ...
          <div className="absolute inset-x-0 top-[calc(100%-13rem)] -z-10 transform-gpu overflow-clip blur-3xl sm:top-[calc(100%-30rem)]">
            <svg
